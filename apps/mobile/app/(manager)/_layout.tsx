...
const nav = [
  ...
  {
    label: 'Wilayah dan Pelanggan',
    href: '/(manager)/customers',
    icon: 'map',
    matches: ['/(manager)/households', '/(manager)/service-plans', '/(manager)/subscriptions'],
  },
  { label: 'Tagihan', href: '/(manager)/billing', icon: 'credit-card' },
  {
    label: 'Kalender dan Rute',
    href: '/(manager)/routes',
    icon: 'calendar',
    matches: ['/(manager)/calendars', '/(manager)/runs', '/(manager)/vehicles'],
  },
  { label: 'Petugas dan Kartu', href: '/(manager)/collectors', icon: 'users' },
  {
    label: 'Timbang dan Pemilahan',
    href: '/(manager)/weighing',
    icon: 'archive',
    matches: ['/(manager)/weigh-stations'],
  },
